...
class Graph
{
    ...
    {
        if (end.distance > start.distance + weight && start.distance != Integer.MAX_VALUE)
        {
    ...
    public void dijkstra(Graph graph, int source)
    {
        ...
        displayMinimumDistances(graph, source);
    }

    public void displayMinimumDistances(Graph graph, int source)
    {
        for (int i = 0; i < graph.numberOfNodes; i++)
        {
